...
<?php // asset helper function referenced below knows to find the css/main.css in the public folder by default ?>
...
<body>
	<div class="welcome">
		...
		<a href="{{ url('/') }}" title="Windward Software and Consulting"><img src="<?php echo asset('images/windwardAppleTouch.png'); ?>" alt="Windward Software and Consulting"></a> 
		<h1 class="highlight">You have arrived at Windward.</h1>
	</div>
</body>
</html>
